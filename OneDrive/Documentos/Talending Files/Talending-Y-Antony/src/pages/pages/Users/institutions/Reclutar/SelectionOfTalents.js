                      ...
                      >
                        ...
                        <TableCell align="right">
                          <IconButton
                            ...
                            onClick={() =>
                              handdlePath(
                                `/institution/community/talents/view_talent`,
                                row.talentId
                              )
                            }
                          >
      ...
      <Grid justifyContent="space-between" container spacing={10}>
        ...
        <Grid item>
          <Button
            ...
            variant="contained"
            color="info"
            onClick={() => handlePageChange("/institution/community/talents")}
            mt={3}
            ml={3}
          >
            Volver
...
export default SelectionOfTalents;
